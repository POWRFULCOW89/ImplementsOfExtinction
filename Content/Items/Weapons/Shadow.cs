...
namespace IOE.Content.Items.Weapons
{
    public class Shadow : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ProjectileID.FireArrow; // ID of the projectiles the sword will shoot
            Item.shootSpeed = 20f;
        }
    ...
    public class DashPlayer : ModPlayer
    {
        ...
        //public bool HoldingDashItem = false;
        ...
        {
            return Player.HeldItem.ModItem is Shadow
